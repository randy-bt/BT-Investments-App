...
const OPTIONS = [
  {
    ...
    sub: "Fastest close",
    desc:
      "Get a fair cash offer with no obligation. Close in 7 days, zero repairs, no showings.",
    bullets: [
      "Close in 7 days",
  ...
  },
  {
    ...
    desc:
      "Seller financing, lease options, or subject-to deals — terms tailored to you.",
    bullets: [
      "Higher total price",
      "Monthly passive income",
      "Installment-sale tax benefits",
      "Flexible custom terms",
      "We manage all payments",
    ],
    featured: false,
  },
  {
    ...
    desc:
      "List on the open market — we handle everything to maximize your sale price.",
    bullets: [
    ...
    >
      <div className="mx-auto max-w-7xl px-6 sm:px-10 pt-20 pb-12 sm:pt-28 sm:pb-16">
        ...
        <div className="mt-12 sm:mt-16 grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-6">
          {OPTIONS.map((opt) => (
            <OptionCard key={opt.key} option={opt} />
          ))}
        </div>
      </div>
    </section>
