...
export function FloatingIndicaButton(props: FloatingIndicaButtonProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-7 right-20 z-50 pointer-events-none rounded-full px-3 py-1.5 text-sm font-medium text-white shadow-lg transition-all duration-200 ${
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full text-white shadow-lg transition-transform duration-200 hover:scale-125"
