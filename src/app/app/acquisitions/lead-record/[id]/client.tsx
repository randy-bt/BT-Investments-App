    ...
    <section className="space-y-6">
      ...
      <div className="rounded-lg border border-dashed border-neutral-300 bg-white p-6 shadow-sm">
        ...
        <div className="mt-8 mb-1 flex justify-end">
          <div
            className="select-none rounded border border-neutral-300/70 px-4 py-1.5 text-center dark:border-neutral-700/70"
            style={{ boxShadow: "inset 0 0 0 1px rgba(0,0,0,0.025)" }}
          >
            <div className="mb-0.5 text-[0.45rem] uppercase tracking-[0.3em] text-neutral-400 dark:text-neutral-500">
              Acquisition Lead
            </div>
            <div
              className="text-base leading-none text-neutral-500 dark:text-neutral-300"
              style={{
