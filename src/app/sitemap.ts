...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const fixed: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/infinitemedia`, changeFrequency: "monthly", priority: 0.4 },
    { url: `${base}/infinitemedia/menu`, changeFrequency: "monthly", priority: 0.3 },
    { url: `${base}/infinitemedia/portfolio`, changeFrequency: "monthly", priority: 0.3 },
    { url: `${base}/infinitemedia/contact`, changeFrequency: "monthly", priority: 0.3 },
